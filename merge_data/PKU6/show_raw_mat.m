% --- 1. 设置路径和参数 ---
% 包含SC矩阵文件的文件夹路径
data_folder = '/ibmgpfs/cuizaixu_lab/xuxiaoyu/PKU6/SCmat_Du15_all';

% 要匹配的文件后缀
file_pattern = '*_sift_invnodevol_count.csv';

% 图像保存路径和文件名
output_image_file = '/ibmgpfs/cuizaixu_lab/xuhaoshu/SC_ADHD/datasets/PKU6/figures/average_raw_SC_matrix_Du15.png';
