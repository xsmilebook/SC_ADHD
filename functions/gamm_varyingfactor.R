...
gamm.varyingcoefficients <- function(region, zscale = F, dataname, smooth_var, int_var, covariates, knots, set_fx = FALSE, increments, draws, return_posterior_coefficients = FALSE){
